module github.com/seongpil0948/otel-kafka-pg/cmd/app

go 1.24

require (
	github.com/seongpil0948/otel-kafka-pg/modules/common v0.0.0
	github.com/seongpil0948/otel-kafka-pg/modules/kafka v0.0.0
...
replace (
	...
	github.com/seongpil0948/otel-kafka-pg/modules/kafka => ../../modules/kafka
